...
Route::group([
    ...
    $router->get('contract-risk/contract_risk_detail','ContractRiskController@contract_risk_detail');
    $router->get('contract-risk/symbol_enable','ContractRiskController@symbol_enable');
    $router->resource('follow-plans','FollowPlanController');
    $router->resource('follow-records','FollowRecordController');
    $router->resource('time-orders','TimeOrderController');
    ...
    $router->resource('contract-tmp','ContractTmpController');
    // 用户日志
    ...
    $router->resource('rechargeManualrg', 'RechargeManualrgController');
    ...
    // 佣金配置
    $router->resource('reward-config','RewardConfigController');#佣金配置  //小白
    $router->resource('user-sign','UserSignController');#签到  //小白


    $router->resource('bank-config', 'BankConfigController');
    $router->resource('bank-import', 'BankImportController');
