...
class ModifyPayPassword extends RowAction
{
    /**
     * @return string
     */
    protected $title = '修改交易密码';

    public function render()
    {
        $id = "user-ModifyPayPassword-{$this->getKey()}";
...
HTML;
    ...
    {
        // 工具表单
        $form = new \App\Admin\Forms\User\ModifyPayPassword($this->getKey());
