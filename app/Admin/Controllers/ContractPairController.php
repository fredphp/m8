...
//            $grid->column('contract_coin_name');
            $grid->column('type','币种');
            $grid->column('unit_amount','每张价值');
            $grid->column('maker_fee_rate','maker费率');
            $grid->column('taker_fee_rate','taker费率');
            $grid->column('lever_rage','杠杆')->label();
            $grid->column('default_lever','默认杠杆')->label('info');
//            $grid->column('min_qty');
//            $grid->column('max_qty');
