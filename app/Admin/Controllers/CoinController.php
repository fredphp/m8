...
//            $grid->guding_query_link->editable();
            $grid->total_issuance;
...
//            $grid->coin_transfer_message;
            ...
            $grid->filter(function (Grid\Filter $filter) {
                ...
                $filter->equal('status')->width(3)->select([0 => '禁用',1 => '启用']);
    ...
    protected function form()
    {
        return Form::make(new Coins(), function (Form $form) {
            ...
            $form->select("is_czlx",'充值类型')->options([0=>"U盾充值",1=>"人工充值"])->default(0);
            //$form->text('jiedianwangluo');
            $form->text('guding_query_link');
