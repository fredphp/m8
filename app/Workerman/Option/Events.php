...
class Events
{
    ...
    public static function onWorkerStart($businessWorker)
    {
        ...
        try{
            ...
            Log::info('exchange-ws 错误信息'.$exception->getMessage());
        }
    }
    ...
    {
        Log::info('exchange-ws 链接成功' . $client_id);
        echo '链接成功 id:'.$client_id;
    }
