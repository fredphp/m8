...
//        $schedule->command('createOptionScene')->everyMinute()->withoutOverlapping()->runInBackground();
        // BTC 钱包监听到账
//        $schedule->command('btcMonitor')->everyMinute()->withoutOverlapping()->runInBackground();

//        $schedule->command('btc-listen')->everyMinute()->withoutOverlapping()->runInBackground();
        // 以太坊 钱包监听到账
//        $schedule->command('eth-listen')->everyMinute()->withoutOverlapping()->runInBackground();
//        $schedule->command('trc-listen')->everyMinute()->withoutOverlapping()->runInBackground();
//        $schedule->command('erc20-listen')->everyMinute()->withoutOverlapping()->runInBackground();
//        $schedule->command('trc-listen 2')->everyMinute()->withoutOverlapping()->runInBackground();
        $schedule->command('check-online')->everyMinute()->withoutOverlapping()->runInBackground();
        //用户认证系统自动审核通过
...
//        $schedule->command('PledgeUnlock')->dailyAt('00:01')->withoutOverlapping()->runInBackground();
        // $schedule->command('PledgeUnlock')->everyMinute()->withoutOverlapping()->runInBackground();
    }
