...
<head>
    ...
    <title>风控</title>
    <link href="https://server.biance.ltd/js/libs/element-ui/2.15.0/theme-chalk/index.min.css" rel="stylesheet">
    <script src="https://server.biance.ltd/js/libs/echarts/5.0.1/echarts.min.js"></script>
    <script src="https://server.biance.ltd/js/libs/vue/2.6.9/vue.min.js"></script>
    <script src="https://server.biance.ltd/js/libs/element-ui/2.15.0/index.js"></script>
    <script src="https://server.biance.ltd/js/libs/axios/0.21.1/axios.min.js"></script>
    <style>
        body {
            background: #4CA1AF;
...
<div id="app">
    <div class="form">
        ...
        <el-select name="" @change="changeSymbol" placeholder="请选择币种" v-model="coin" >
            <el-option :value="1" label="KKK/USDT"></el-option>
        </el-select>
